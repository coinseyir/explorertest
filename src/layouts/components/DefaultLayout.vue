...
<template>
  <div class="bg-gray-50 dark:bg-gray-900">
    <!-- sidebar -->
    <div
      class="w-64 fixed z-50 left-0 top-0 bottom-0 overflow-auto bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700"
      :class="{ block: sidebarShow, 'hidden xl:!block': !sidebarShow }"
    >
      <div class="flex justify-between mt-1 pl-4 py-4 mb-1">
        <RouterLink to="/" class="flex items-center">
          <img class="w-10 h-10" src="../../assets/logo.svg" />
          <h1 class="flex-1 ml-3 text-2xl font-semibold dark:text-gray-100">
            Ping.pub
          </h1>
        </RouterLink>
        <div
      ...
      >
        ...
        >
          ...
          />
          <div
            class="collapse-title !py-0 px-4 flex items-center cursor-pointer hover:bg-blue-50 dark:hover:bg-blue-900"
          >
            <Icon
              v-if="item?.icon?.icon"
              :icon="item?.icon?.icon"
              class="text-xl mr-2"
              :class="{
                'text-orange-500': item?.title === 'Favorite',
            ...
            />
            <div
              class="text-base capitalize flex-1 text-gray-800 dark:text-gray-100 whitespace-nowrap"
            >
              {{ item?.title }}
            </div>
            <div
        ...
        >
          ...
          <img
            v-if="item?.icon?.image"
            :src="item?.icon?.image"
            class="w-6 h-6 rounded-full mr-3 border border-indigo-100"
          />
          <div
            class="text-base capitalize flex-1 text-gray-800 dark:text-gray-100 whitespace-nowrap"
          >
        ...
        <div
          ...
          class="px-4 text-sm text-gray-500 pb-2 uppercase"
        >
          {{ item?.heading }}
        </div>
      </div>
      <div class="px-2">
        ...
        <Sponsors />
        <div class="px-4 text-sm pt-2 text-gray-500 pb-2 uppercase">{{ $t('module.links') }}</div>
        <a
        ...
        <a
          ...
          target="_blank"
          class="py-2 px-4 flex items-center rounded-lg cursor-pointer hover:bg-blue-50 dark:hover:bg-blue-900"
        >
    ...
    <div class="xl:!ml-64 px-3 pt-4">
      <!-- header -->
      <div
        class="flex items-center py-3 bg-white dark:bg-gray-800 mb-4 rounded px-4 sticky top-0 z-10"
      >
        <div
